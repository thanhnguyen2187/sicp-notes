; When we implement the Lisp evaluator in Section 4.1, we saw how to use local
; environments to avoid name conflicts between the parameters of procedures. For
...
; I supposed that P were true, then I would be able to deduce A and B.") as a
; method of problem solving? (This problem is open-ended. A good answer is
