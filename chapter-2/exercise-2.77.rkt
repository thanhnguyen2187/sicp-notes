...
; the object shown in Figure 2.24. To his suprise, instead of the answer `5` he
; gets an error message from `apply-generic` on the types `(complex)`. He shows
; this interaction to Alyssa P. Hacker, who says "The problem is that the
...
; `apply-generic` invoked? What procedure is displatched to in each case?
