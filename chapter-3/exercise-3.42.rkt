...
; ---
;
; > Serializers are constructed by `make-serializer`, whose implementation is
; given below. A serializer takes a procedure as argument and returns a
; serialized procedure that behave like the original procedure. All calls to a
