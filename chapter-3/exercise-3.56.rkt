...
; than 2, 3, or 5.
;
; One obivious way to do this is to simply test each integer in turn to see
; whether it has any factors other than 2, 3, and 5. But this is very
; inefficient, since, as the integers get larget, fewer and fewer of them fit
; the requirement.
;
...
;
; Now all we have to do is combine elements from these resources. For this we
